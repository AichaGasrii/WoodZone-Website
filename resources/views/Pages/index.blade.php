            ...
            <div class="row">
                <div class="single-col">
                    <div class="single-banner">
                        ...
                        <div class="banner-content">
                            ...
                            <span class="title" >6 Square Pieces<br>
                               Coaster Set</span>
                ...
                <div class="single-col center-col">
                    <div class="single-banner">
                        ...
                        <div class="banner-content">
                            <span class="category">Best Seller</span>
                            <span class="title">Wooden Rustic <br>
                            Kitchen Table Bowls</span>
                            <a href="/shopCategories" class="shop-link btn btn-primary text-uppercase">Shop
                                Now</a>
                        </div>
                    </div>
                ...
                <div class="single-col">
                    <div class="single-banner">
                        ...
                        <div class="banner-content">
                            <span class="category">Best Seller</span>
                            <span class="title">6 Round Pieces<br>
                               Coaster Set</span>
                            <a href="/shopCategories" class="shop-link btn btn-primary text-uppercase">Shop
                                Now</a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-title text-center mb-60px">
                        ...
                        <p>Olive wood products are highly popular due to their durability,
                 natural beauty, and unique grain patterns. They are perfect for both practical 
                 and decorative purposes. Here are some categories of our olive wood products. </p>
                    </div>
                    <!-- Tab Start -->
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="/produitDetails">Antique Wooden Farm Large
                                                </a>
                                            </h5>
                                            <span class="price">
                                                <span class="new">$38.50</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6  mb-md-30px mb-lm-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="/produitDetails">Knitting yarn & crochet hook
                                                </a>
                                            </h5>
                                            <span class="price">
                                                <span class="new">$38.50</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="/produitDetails">David Head Portraits
                                                </a>
                                            </h5>
                                            <span class="price">
                                                <span class="new">$38.50</span>
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="/produitDetails">solid wood cherry paddle
                                                </a>
                                            </h5>
                                            <span class="price">
                                                <span class="new">$38.50</span>
                    ...
                    <div class="tab-slider nav-center">
                        <ul class="product-tab-nav nav justify-content-center align-items-center">
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                    href="#tab-fabric-2"><span>Trays</span></a>
                            </li>
                            ...
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                    href="#tab-pottery-2"><span>Jars</span></a>
                            </li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
